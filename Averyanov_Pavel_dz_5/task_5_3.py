...
tutors = ['Иван', 'Анастасия', 'Петр', 'Сергей',  'Дмитрий', 'Борис', 'Елена', 'Матрена', 'Антон', 'Семен']
klasses = ['9А', '7В', '9Б', '9В', '8Б', '10А', '10Б', '9А']

length_tutors_in = len(tutors)
zippedlistGen = (itertools.zip_longest(tutors, klasses, fillvalue=None) for _ in range(0, length_tutors_in))
print(type(zippedlistGen))
print(*next(zippedlistGen))
